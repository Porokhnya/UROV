...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
#define RELAY_LINE_ALL_WAIT_INTERVAL      500  // пауза после включения всех линий и до включения шунта 1 (миллисекунд)
...
#define RELAY_PROTECT_WAIT_INTERVAL       10    // пауза после включения реле аварии до старта генерации импульсов (миллисекунд)
#define RELAY_SHUNT2_OFF_INTERVAL         50   // пауза после генерации импульсов до отключения шунта 2 (миллисекунд)
