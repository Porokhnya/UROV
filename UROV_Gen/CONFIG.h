...
#define RELAY_SHUNT1_WAIT_INTERVAL        1000  // пауза после включения шунта 1 до включения шунта 2 (миллисекунд)
#define RELAY_SHUNT2_WAIT_INTERVAL        100   // пауза после включения шунта 2 до включения реле аварии (миллисекунд)
