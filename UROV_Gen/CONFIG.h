...
#define GEN_TIMER_PERIOD 2                  // интервал таймера, микросекунд
#define PULSE_WIDTH  10                     // ДЛИТЕЛЬНОСТЬ ИМПУЛЬСА, МИКРОСЕКУНД
#define TOTAL_POINTS_IN_CHART 50           // сколько точек надо получить на графике импульсов?
#define PULSE_CHART_WORK_TIME 120           // время работы всего графика импульсов, миллисекунд
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define ENCODER_PIN1 100                  // номер пина, на котором ловятся импульсы от энкодера штанги
#define ENCODER_INTERRUPT_LEVEL RISING   // по какому уровню ловим прерывания
#define ENCODER_PIN2 101                  // номер пина 2, на котором ловятся импульсы от энкодера штанги
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define RELAY_PIN 101                     // пин, на котором ловятся импульсы срабатывания защиты
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define ROD_ENDSTOP_UP 100           // Концевик позиции штанги №1, вверху
#define ROD_ENDSTOP_DOWN 101          // Концевик позиции штанги №1, внизу
