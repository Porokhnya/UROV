...
#define SENSOR_1_DRAW_X 10 // X-координата отрисовки данных первого датчика
#define SENSOR_1_DRAW_Y 10 // Y-координата отрисовки данных первого датчика

#define SENSOR_2_DRAW_X 30 // X-координата отрисовки данных второго датчика
#define SENSOR_2_DRAW_Y 30 // Y-координата отрисовки данных второго датчика
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define BUTTON_RED    51                // Кнопка №1, красная  Старт теста
#define BUTTON_BLUE   13                // Кнопка №2, синяя    Подать ток на фазу "А"
#define BUTTON_BLACK  12                // Кнопка №3, черная   Подать ток на фазу "В"
#define BUTTON_GREY   11                // Кнопка №4, серая    Подать ток на фазу "С"
