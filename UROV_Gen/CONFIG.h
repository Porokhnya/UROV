...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
#define RELAY_LINE_ALL_WAIT_INTERVAL      200  // пауза после включения всех линий и до включения шунта 1 (миллисекунд)
#define RELAY_SHUNT1_WAIT_INTERVAL        20  // пауза после включения шунта 1 до включения шунта 2 (миллисекунд)
#define RELAY_SHUNT2_WAIT_INTERVAL        20   // пауза после включения шунта 2 до включения реле аварии (миллисекунд)
#define RELAY_PROTECT_WAIT_INTERVAL       0    // пауза после включения реле аварии до старта генерации импульсов (миллисекунд)
#define RELAY_SHUNT2_OFF_INTERVAL         50   // пауза после старта генерации импульсов до отключения шунта 2 (миллисекунд)
#define RELAY_SHUNT1_OFF_INTERVAL         50   // пауза после отключения шунта 2 до отключения шунта 1 (миллисекунд)
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// ПИЩАЛКА
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
