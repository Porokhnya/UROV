...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define GEN_TIMER Timer6                    // какой таймер используется (Timer0, Timer1 и т.п.)
#define GEN_TIMER_PERIOD 100                  // интервал таймера, микросекунд
#define PULSE_WIDTH  10                     // ДЛИТЕЛЬНОСТЬ ИМПУЛЬСА, МИКРОСЕКУНД
#define TOTAL_POINTS_IN_CHART 100           // сколько точек надо получить на графике импульсов?
