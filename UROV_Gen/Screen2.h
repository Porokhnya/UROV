...
private:
      ...
      int backButton, /*sdFormatButton, sdInfoButton, filesButton, ethalonButton*/ filesButton, sdScreenButton, adjustTimeButton, paramsScreenButton;
...
private:
      ...
      int createEncoderChartButton, loadEncoderChartButton, chartSettingsButton, relayDelayButton, backButton;
