...
//		void serialRx(void);
		...
		void getInputRegister(byte, word, word);
		...
		void setRxTxSwitch(uint8_t pin);

	private:
		Stream *port; ///< Pointer to Serial class object
		uint8_t *_msg,
		//byte *_msg,
			  _len;
	...
	//	byte _serno;
		...
		uint8_t rxtxSwitch; // ïåðåêëþ÷åíèå ïðèåìà/ïåðåäà÷è äëÿ RS-485
