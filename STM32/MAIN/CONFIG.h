...
// версия ПО
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define SOFTWARE_VERSION                              "v.20.04.21"

//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// настройки для общения с конфигуратором UROVConfig через UART
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define CONFIG_SERIAL                  Serial4 // какой Serial использовать для работы с программой UROVConfig.exe
#define CONFIG_SERIAL_SPEED            115200 // скорость работы с CONFIG_SERIAL
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------

//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// настройки для общения с конфигуратором UROVModbus через UART
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define MODBUS_SERIAL           Serial//4       // какой Serial для общения с MODBUS
#define MODBUS_BAUD             57600   // скорость Serial для работы с MODBUS
#define MODBUS_RX_TX_SWITCH     PD12//0xFF    // номер вывода для переключения приема/передачи по RS-485 для MODBUS (0xFF - не используется)
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// Допустимые диапазоны настроек
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Кол-во импульсов: [1 - 10 000]
#define DIA_PULSES_A    1
#define DIA_PULSES_B    10000

// Дельта времени импульса при сравнении с эталоном: [1 - 10000]
#define DIA_ETL_COMPARE_A   1
#define DIA_ETL_COMPARE_B   10000

// Дельта кол-ва импульсов при сравнении: [0 - 255]
#define DIA_PULSES_DELTA_A  0
#define DIA_PULSES_DELTA_B  255

// Текущий моторесурс: [0 - 100 000]
#define DIA_MOTORESOURCE_A    0
#define DIA_MOTORESOURCE_B    100000

// Максимальный моторесурс: [0 - 100 000]
#define DIA_MOTORESOURCE_MAX_A    0
#define DIA_MOTORESOURCE_MAX_B    100000

// Нижний порог трансформатора: [0 - 4096]
#define DIA_TRANS_L_BORDER_A    0
#define DIA_TRANS_L_BORDER_B    4096

// Верхний порог трансформатора: [0 - 4096]
#define DIA_TRANS_H_BORDER_A    0
#define DIA_TRANS_H_BORDER_B    4096

// Ожидание данных энкодера: [0 - 10 000]
#define DIA_RELAY_DELAY_A   0
#define DIA_RELAY_DELAY_B   10000

// Время завершения ожидания импульсов: [0 - 10 000 000]
#define DIA_MAX_IDLE_TIME_A   0
#define DIA_MAX_IDLE_TIME_B   10000000

// Пропуск импульсов: [0 - 100]
#define DIA_SKIP_PULSES_A   0
#define DIA_SKIP_PULSES_B   100

// Коэффициент тока: [1 - 100 000]
#define DIA_CURRENT_COEFF_A   1
#define DIA_CURRENT_COEFF_B   100000

// Величина перемещения штанги: [1 - 1000]
#define DIA_ROD_MOVE_LENGTH_A   1
#define DIA_ROD_MOVE_LENGTH_B   1000
...
#define MODBUS_REG_PULSES                         40001 // регистр для количества импульсов
#define MODBUS_REG_PULSES_DELTA                   40002 // регистр для дельты импульсов
#define MODBUS_REG_ETHALON_PULSES_DELTA1          40003 // регистр 1 для дельты времени сравнения импульсов с  эталоном
#define MODBUS_REG_ETHALON_PULSES_DELTA2          40004 // регистр 2 для дельты времени сравнения импульсов с  эталоном
#define MODBUS_REG_MOTORESOURCE1                  40005 // регистр 1 для моторесурса
#define MODBUS_REG_MOTORESOURCE2                  40006 // регистр 2 для моторесурса
#define MODBUS_REG_MOTORESOURCE_MAX1              40007 // регистр 1 для максимального моторесурса
#define MODBUS_REG_MOTORESOURCE_MAX2              40008 // регистр 2 для максимального моторесурса
#define MODBUS_REG_TLOW_BORDER1                   40009 // регистр 1 для нижнего порога трансформатора
#define MODBUS_REG_TLOW_BORDER2                   40010 // регистр 2 для нижнего порога трансформатора
#define MODBUS_REG_THIGH_BORDER1                  40011 // регистр 1 для верхнего порога трансформатора
#define MODBUS_REG_THIGH_BORDER2                  40012 // регистр 2 для верхнего порога трансформатора
#define MODBUS_REG_RDELAY1                        40013 // регистр 1 для задержки реле
#define MODBUS_REG_RDELAY2                        40014 // регистр 2 для задержки реле
#define MODBUS_REG_ACSDELAY                       40015 // регистр 1 для задержки ACS
#define MODBUS_REG_SKIPC1                         40016 // регистр 1 для пропуска импульсов
#define MODBUS_REG_SKIPC2                         40017 // регистр 2 для пропуска импульсов
#define MODBUS_REG_CCOEFF1                        40018 // регистр 1 для коэффициента тока
#define MODBUS_REG_CCOEFF2                        40019 // регистр 2 для коэффициента тока
#define MODBUS_REG_ASUTPFLAGS                     40020 // регистр для флагов АСУ ТП
#define MODBUS_REG_MAXIDLETIME1                   40021 // регистр 1 для времени ожидания окончания импульсов
#define MODBUS_REG_MAXIDLETIME2                   40022 // регистр 2 для времени ожидания окончания импульсов
#define MODBUS_REG_RODMOVELEN1                    40023 // регистр 1 для величины перемещения штанги
#define MODBUS_REG_RODMOVELEN2                    40024 // регистр 2 для величины перемещения штанги

#define MODBUS_REG_SAVECHANGES                    40025 // регистр для флага сохранения настроек, ДОЛЖЕН БЫТЬ ПОСЛЕДНИМ ПО НОМЕРУ СРЕДИ РЕГИСТРОВ НАСТРОЕК!!!


#define MODBUS_REG_YEAR                           40500 // регистр для года
#define MODBUS_REG_MONTH                          40501 // регистр для месяца
#define MODBUS_REG_DAY                            40502 // регистр для дня
#define MODBUS_REG_HOUR                           40503 // регистр для часов
#define MODBUS_REG_MINUTE                         40504 // регистр для минут
#define MODBUS_REG_SECOND                         40505 // регистр для секунд


// Далее идут служебные регистры для всяких функций, например, передачи файлов

#define MODBUS_REG_FILE_SIZE1                     40998 // регистр размера файла 1
#define MODBUS_REG_FILE_SIZE2                     40999 // регистр размера файла 2
#define MODBUS_REG_FUNCTION_NUMBER                41000 // регистр для номера запрошенной мастером функции (например, выдать список файлов в директории)
#define MODBUS_REG_READY_FLAG                     41001 // регистр флага готовности запрошенной мастером информации (например, выдано имя одного файла). Мастер проверяет этот флаг периодически.
#define MODBUS_REG_CONTINUE_FLAG                  41002 // регистр флага необходимости продолжения запроса мастером (например, когда ещё есть имена файлов в списке). Если 0 - то передача от слейва завершена.
#define MODBUS_REG_FILE_FLAGS                     41003 // регистр флага признаков файла (0 - нет файла, 1 - обычный файл, 2 - папка).
#define MODBUS_REG_DATA_LENGTH                    41004 // регистр длины выданных или переданных от мастера данных (например, длины имени файла)
#define MODBUS_REG_DATA                           41005 // регистр, начиная с которого идут данные (например, имя файла)
#define MODBUS_PACKET_LENGTH                      125   // максимальное кол-во регистров в пакете данных
