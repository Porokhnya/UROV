...
#define CURRENT_OSCILL_FREQ               1000 // через сколько микросекунд собирать значение тока с АЦП, для помещения в список
...
#define COUNT_OF_FULL_CURRENT_LIST        200  // сколько записей должно быть в списке по току, не считая записей в списке предпросмотра
#define COUNT_OF_CURRENT_PREVIEW_RECORDS  100 // кол-во записей в списке предпросмотра перед превышением по току
