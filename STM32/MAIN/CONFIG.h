...
// версия ПО
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define SOFTWARE_VERSION                              "v.06.04.21"

//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// настройки Serial для общения с конфигуратором UROVConfig через UART
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define MODBUS_RX_TX_SWITCH     0xFF    // номер вывода для переключения приема/передачи по RS-485 для MODBUS (0xFF - не используется)
