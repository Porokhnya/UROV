...
#define COUNT_OF_FULL_CURRENT_LIST        10  // сколько записей должно быть в списке по току, не считая записей в списке предпросмотра
#define COUNT_OF_CURRENT_PREVIEW_RECORDS  40 // кол-во записей в списке предпросмотра перед превышением по току
