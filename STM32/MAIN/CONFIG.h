...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define MIN_SD_WRITE_SPEED 5000 // минимальная допустимая скорость записи на SD (Кб/с)
#define MIN_SD_READ_SPEED 8000 // минимальная допустимая скорость чтения с SD (Кб/с)
