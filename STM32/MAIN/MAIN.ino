...
void setup() // настройка системы в работу
{
  ...
  CONFIG_SERIAL.begin(CONFIG_SERIAL_SPEED);
  while(!CONFIG_SERIAL && millis() < 2000);
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
bool nestedYield = false; // флаг вложенных вызовов функции yield
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#ifndef _YIELD_OFF
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ArduinoOutStream cout(CONFIG_SERIAL);
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
