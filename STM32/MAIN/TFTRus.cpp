...
// ТАБЛИЦА ПЕРЕКОДИРОВКИ ШРИФТА В РУССКИЙ АЛФАВИТ
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void TFTRus::init(TFT_Class* uTft) // инициализация
{
   pDisplay = uTft;
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
int TFTRus::getStringLength(const char* str) // возвращает длину UTF-8 строки в символах
{
  return utf8_strlen(str);
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
int TFTRus::textWidth(const char* str) // возвращает ширину текста в пикселях
{
  return print(str,0,0,BLACK,BLACK,true);
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
int TFTRus::print(const char* st,int x, int y, word bgColor, word fgColor, bool computeTextWidthOnly) // печатает строку на экране
{ 
  if(!st)
  {
    return 0; 
