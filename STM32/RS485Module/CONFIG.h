...
#define WATCHDOG_REBOOT_PIN PA4 // номер пина, на котором будут меняться уровни
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// НАСТРОЙКИ ВНУТРЕННЕГО ВАТЧДОГА
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define USE_INTERNAL_WATCHDOG // использовать или нет строенный ватчдог
