...
#define INDICATION_PIN  10 // номер пина для индикации, на котором висит светодиод индикации
...
// настройки RS-485
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define RS485_DE_PIN                      PB13          // номер пина управления режимом приёма/передачи MAX485
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define RELAY_PIN                         24         // пин, на котором ловятся импульсы срабатывания защиты
...
#define ENCODER_PIN1                      PB6         // номер пина, на котором ловятся импульсы от энкодера штанги
#define ENCODER_INTERRUPT_LEVEL           RISING      // по какому уровню ловим прерывания энкодера

#define ENDSTOP_UP_PIN                    PA6           // Концевик позиции штанги, вверху
#define ENDSTOP_DOWN_PIN                  PA7           // Концевик позиции штанги, внизу
