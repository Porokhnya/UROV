...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
<<<<<<< HEAD
#define RS485_DE_PIN                      4          // номер пина управления режимом приёма/передачи MAX485
...
#define RETRANSMITS_COUNT                 3            // сколько раз пытаться переслать пакет, при отсутствии подтверждения штатного приёма пакета
...
#define ENDSTOP_UP_PIN                    9           // Концевик позиции штанги, вверху
