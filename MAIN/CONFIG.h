...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define NUM_RODS 1 // кол-во штанг
#define ENCODER_PIN1 12 // номер пина, на котором ловятся импульсы от энкодера штанги
#define ENCODER_PIN2 A8 // номер пина 2, на котором ловятся импульсы от энкодера штанги
//DEPRECATED: #define INTERRUPT2_PIN 7
//DEPRECATED: #define INTERRUPT3_PIN 8
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// настройки пинов из ConfigPin.h
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// Входа контроллера
//DEPRECATED: #define inductive_sensor1 A6          //Вход индуктивного датчика №1  (60)
//DEPRECATED: #define inductive_sensor2 A7          //Вход индуктивного датчика №2  (61)
//DEPRECATED: #define inductive_sensor3 A8          //Вход индуктивного датчика №3  (62)
...
#define ROD_ENDSTOP_UP A6          // Концевик позиции штанги №1, вверху
#define ROD_ENDSTOP_DOWN A7          // Концевик позиции штанги №1, внизу
#define ROD_ENDSTOP_TRIGGERED LOW // уровень, когда концевик штанги сработал

//DEPRECATED: #define ROD_POSITION2_PIN1 11          // Вход для чтения позиции штанги №2, вверху
//DEPRECATED: #define ROD_POSITION2_PIN2 12          // Вход для чтения позиции штанги №2, внизу

//DEPRECATED: #define ROD_POSITION3_PIN1 11          // Вход для чтения позиции штанги №3, вверху
//DEPRECATED: #define ROD_POSITION3_PIN2 12          // Вход для чтения позиции штанги №3, внизу
...
//DEPRECATED: #define COUNT_PULSES_STORE_ADDRESS2 12 // по какому адресу храним переменную для кол-ва импульсов канала 2 (2 байта)
//DEPRECATED: #define COUNT_PULSES_STORE_ADDRESS3 14 // по какому адресу храним переменную для кол-ва импульсов канала 3 (2 байта)

// дельты импульсов по каналам
#define CHANNEL_PULSES_DELTA_ADDRESS1 16 // адрес хранения дельты импульсов канала 1 (1 байт)
//DEPRECATED: #define CHANNEL_PULSES_DELTA_ADDRESS2 17 // адрес хранения дельты импульсов канала 1 (1 байт)
//DEPRECATED: #define CHANNEL_PULSES_DELTA_ADDRESS3 18 // адрес хранения дельты импульсов канала 1 (1 байт)

// моторесурс по каналам
#define MOTORESOURCE_STORE_ADDRESS1  100 // адрес хранения кол-ва срабатываний защиты канала 1 (4 байта)
//DEPRECATED: #define MOTORESOURCE_STORE_ADDRESS2  104 // адрес хранения кол-ва срабатываний защиты канала 2 (4 байта)
//DEPRECATED: #define MOTORESOURCE_STORE_ADDRESS3  108 // адрес хранения кол-ва срабатываний защиты канала 3 (4 байта)

#define MOTORESOURCE_MAX_STORE_ADDRESS1  112 // адрес хранения макс. кол-ва срабатываний защиты канала 1 (4 байта)
//DEPRECATED: #define MOTORESOURCE_MAX_STORE_ADDRESS2  116 // адрес хранения макс. кол-ва срабатываний защиты канала 2 (4 байта)
//DEPRECATED: #define MOTORESOURCE_MAX_STORE_ADDRESS3  120 // адрес хранения макс. кол-ва срабатываний защиты канала 3 (4 байта)
