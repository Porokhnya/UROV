...
#define ENCODER_PIN2 A6 // номер пина 2, на котором ловятся импульсы от энкодера штанги
...
#define ROD_ENDSTOP_UP 12          // Концевик позиции штанги №1, вверху
#define ROD_ENDSTOP_DOWN 47          // Концевик позиции штанги №1, внизу
