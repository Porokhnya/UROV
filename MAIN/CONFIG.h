...
#define RS485_SERIAL Serial1 // какой Serial используем для RS-485
#define RS485_SPEED  57600 // какая скорость для RS-485
#define RS485_READING_TIMEOUT 10 // таймаут на чтение входящих данных, миллисекунд
#define RS485_ANSWER_TIMEOUT 20 // таймаут на ожидание ответа с модуля, миллисекунд
#define RS485_PING_FREQ 20 // через сколько миллисекунд проверять наличие прерывания у модуля?
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
extern RS485 rs485;
extern void waitRS485Release(); // ожидаем освобождения RS-485
extern void OnRS485IncomingData(RS485* Sender);
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
