...
#define _DISABLE_USING_CHART_IN_MAIN_SCREEN // не использовать класс Chart на главном экране
#define _DISABLE_DRAW_SOFTWARE_VERSION // не рисовать версию ПО на главном экране
#define _REPLACE_INTERRUPT_HANDLER_WITH_FAKE_TRIGGER // заменить обработчик прерываний периодическим "срабатыванием" раз в 10 секунд
