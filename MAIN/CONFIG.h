...
#define INTERRUPT_PIN 35 // номер пина, на котором ловятся импульсы от энкодера штанги
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// настройка индуктивных датчиков
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define INDUCTIVE_CHANNEL1_GOOD_STATE 100 // порог напряжения, выше которого для канала 1 будет принято решение, что датчик исправен (0-1023)
#define INDUCTIVE_CHANNEL2_GOOD_STATE 100 // порог напряжения, выше которого для канала 2 будет принято решение, что датчик исправен (0-1023)
#define INDUCTIVE_CHANNEL3_GOOD_STATE 100 // порог напряжения, выше которого для канала 3 будет принято решение, что датчик исправен (0-1023)
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
